...
export default {
  ...
  methods: {
    ...
    async onSendData() {
      ...
      console.log("Progressive tax:", progressiveTax(userInput));
      console.log("Federal tax only:" + taxUpdate.data.federalIncomeTax)
      console.log("Federal tax with progressive tax:" + parseInt(progressiveTax(userInput) + taxUpdate.data.federalIncomeTax));
